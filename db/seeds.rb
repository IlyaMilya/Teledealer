...
e1 = Employee.create!(full_name:"Greg Heffley" , email: "wimpykid@gmail.com" , password: "password"  )
e2 = Employee.create!(full_name:"Harry Potter" , email: "hogwartsdude@gmail.com", password: "voldemortsugly" )
